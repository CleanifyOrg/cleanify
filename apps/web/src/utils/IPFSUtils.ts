...
export const IPFS_API_KEY: string = envConfig.ipfsApiKey;
export const IPFS_SECRET_KEY: string = envConfig.ipfsSecretKey;
export const IPFS_GATEWAY: string = envConfig.ipfsGateway;
